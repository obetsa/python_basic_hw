...
screen.title("Registration")
    #Signuop Title
title = Label(text="SIGN UP",font=("Arial",70,"bold"),padx="5",pady="5",bg="deep sky blue",fg="yellow2").pack(pady="50")
    #signup frame
...
#widget 1
fullname_label = Label(signup_frame,width="15",padx="5",pady="5",text="User Name",bg="yellow2",fg="deep sky blue",font=("Calibri",15,'bold')).grid(row=0,column=0,padx="5",pady="5")
fullname_entry = Entry(signup_frame,textvariable=name,selectbackground="deep sky blue",selectforeground="black",font=("Calibri",15,"italic")).grid(row=0,column=1,padx="15",pady="5")
#widget 2
email_label = Label(signup_frame,width="15",padx="5",pady="5",text="User Email",bg="yellow2",fg="deep sky blue",font=("Calibri",15,'bold')).grid(row=1,column=0,padx="5",pady="5")
...
#widget 3
password_label = Label(signup_frame,width="15",padx="5",pady="5",text="User Password",bg="yellow2",fg="deep sky blue",font=("Calibri",15,'bold')).grid(row=2,column=0,padx="5",pady="5")
...
#widget 4
gender.set("Radio")
gender_label = Label(signup_frame,width="15",padx="5",pady="5",text="User Gender",bg="yellow2",fg="deep sky blue",font=("Calibri",15,'bold')).grid(row=3,column=0,padx="5",pady="5")
...
#widget 5
age_label = Label(signup_frame,width="15",padx="5",pady="5",text="User Age",bg="yellow2",fg="deep sky blue",font=("Calibri",15,'bold')).grid(row=4,column=0,padx="5",pady="5")
...
signup_btn = Button(signup_frame,text="Sign Up",width="30",bg="deep sky blue",fg="yellow2",font=("Arial",15,"italic"),command=validation).grid(row=5,columnspan=2,pady="15",padx="10")
